    ...
    public function init()
    {
        ...
        $this->_viewParams = [
            ...
            'counterParams' => [
                ...
                'webvisor'            => boolval($this->webvisor),
                'trackHash'           => boolval($this->trackHash),
                'clickmap'            => boolval($this->clickmap),
                'trackLinks'          => boolval($this->trackLinks),
                'accurateTrackBounce' => boolval($this->accurateTrackBounce),
